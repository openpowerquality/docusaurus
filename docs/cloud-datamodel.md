...
|-------|------|-------------|
| event_id | int | The event_id generated by an events document |
| box_id | str | The OPQBox from which this data was produced |
...
| boxId | str | The Box owned by this user. A string such as "1", "2" etc. Not the documentID! |
